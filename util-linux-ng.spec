...
# 659612 - support for _rnetdev mount option missing in RHEL
...
%changelog
* Fri Dec  3 2010 Karel Zak <kzak@redhat.com> 2.17.2-6.el6_0.1
- fix #659612 - support for _rnetdev mount option missing in RHEL6
